#!/bin/sh
#SBATCH --job-name 1d_fpr
#SBATCH --partition=normal

#SBATCH --mail-type=BEGIN,END,FAIL         # ALL,NONE,BEGIN,END,FAIL,REQUEUE,..
#SBATCH --mail-user=tsong8@gmu.edu     # Put your GMU email address here

#SBATCH --output=/home/tsong8/676_Final_Project/2d_fixed_beta/%u/%x-%N-%j.out  # Output file
#SBATCH --error=/home/tsong8/676_Final_Project/2d_fixed_beta/%u/%x-%N-%j.err   # Error file
