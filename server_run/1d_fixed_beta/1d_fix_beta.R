...
# Save results to RDS
saveRDS(results, "~/676_Final_Project/1d_fixed_beta/results.RDS")
# saveRDS(run_log, "~/676_Final_Project/1d_fixed_beta/run_log.RDS")

# Save results to CSV, discarding the index column
write.csv(results, "~/676_Final_Project/1d_fixed_beta/results.csv", row.names = FALSE)
# write.csv(run_log, "~/676_Final_Project/1d_fixed_beta/run_log.csv", row.names = FALSE)
