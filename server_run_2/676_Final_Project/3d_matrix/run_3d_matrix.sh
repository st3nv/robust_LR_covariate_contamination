#!/bin/sh
#SBATCH --job-name 3d_matrix
#SBATCH --partition=normal

#SBATCH --mail-type=BEGIN,END,FAIL         # ALL,NONE,BEGIN,END,FAIL,REQUEUE,..
#SBATCH --mail-user=tsong8@gmu.edu     # Put your GMU email address here

#SBATCH --output=/home/tsong8/676_Final_Project/3d_matrix/%x-%N-%j.out  # Output file
#SBATCH --error=/home/tsong8/676_Final_Project/3d_matrix/%x-%N-%j.err   # Error file
